	...
	return apply_filters(
		'avadanta_slider_content', json_encode(
			array(
				...
				'link'      => '#',
                'image_url'     => esc_url(AVATA_PLUGIN_URL . 'library/avadanta/assets/images/slider1.jpg'),
				),
				array(
...
function avata_avadanta_get_clients_default() {
	...
	return apply_filters(
		'avadanta_clients_content', json_encode(
			array(
				array(
				'image_url'     => esc_url(AVATA_PLUGIN_URL . 'library/avadanta/assets/images/client1.png'),
				'link'       => '#',
				),
				array(
				'image_url'     => esc_url(AVATA_PLUGIN_URL . 'library/avadanta/assets/images/client2.png'),
				'link'       => '#',
				),
				array(
				'image_url'     => esc_url(AVATA_PLUGIN_URL . 'library/avadanta/assets/images/client3.png'),
				'link'       => '#',
				),

				array(
				'image_url'     => esc_url(AVATA_PLUGIN_URL . 'library/avadanta/assets/images/client4.png'),
				'link'       => '#',
				),
					array(
				'image_url'     => esc_url(AVATA_PLUGIN_URL . 'library/avadanta/assets/images/client5.png'),
				'link'       => '#',
				),
