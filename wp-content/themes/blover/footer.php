...
?>
		...
		$blover_dafault_footer_text = '&copy; ' . date_i18n( __( 'Y', 'blover' ) ) . ' ' . get_bloginfo( 'name' ) . '<p>  Stanisław Tor 35-604 Rzeszów Kaczeńcowa 18, 30-347 Kraków Kapelanka 5/64 </p>'. '<a href="https://github.com/bartlomiejra">' .
